...
const els = {
    connStatus: $('connStatus'), connDot: $('connDot'), connText: $('connText'),
    modelChip: $('modelChip'),
    // 侧栏
    ...
    // 聊天区
    messages: $('messages'), welcomeHero: $('welcomeHero'),
...
function appendTyping() {
    ...
    t.className = 'typing';
    t.innerHTML = '<div class="typing-avatar">🔥</div><div class="typing-bubble"><i></i><i></i><i></i></div>';
...
function bindEvents() {
    ...
    els.shutdownModal.addEventListener('click', (e) => { if (e.target === els.shutdownModal) closeShutdownModal(); });
}
